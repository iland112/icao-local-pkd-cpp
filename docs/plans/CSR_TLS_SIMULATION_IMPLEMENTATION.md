...
│   │  처리 파이프라인 (5단계):                                     │       │
│   │  ┌──────────┐  ┌────────┐  ┌────────┐  ┌────────┐        │       │
│   │  │ ML→CSCA  │→ │  DSC   │→ │  CRL   │→ │ DSC_NC │        │       │
│   │  │ ML파싱   │  │30,046건│  │  90건  │  │ 502건  │        │       │
│   │  │→CSCA추출 │  │        │  │        │  │        │        │       │
│   │  │ 889건    │  │        │  │        │  │        │        │       │
│   │  └──────────┘  └────────┘  └────────┘  └────────┘        │       │
│   │                                                            │       │
│   │  ※ ICAO PKD에는 o=csca 브랜치 없음                         │       │
│   │  ※ CSCA는 Master List(o=ml) CMS SignedData 안에 포함       │       │
│   │  ※ ML 다운로드 → CMS 파싱 → CSCA/MLSC 추출 → o=csca 저장  │       │
│   │       │           │           │           │                │       │
│   │       ▼           ▼           ▼           ▼                │       │
...
6. 인증서 동기화 (ML→CSCA/DSC/CRL/DSC_NC)       → 31,277건       ✅
   └── ML→CSCA: Master List CMS 파싱 → CSCA 추출 (ICAO PKD DIT 준수)
```
