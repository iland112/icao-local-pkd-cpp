...
| source_type | 건수 | 비율 |
|-------------|------|------|
| LDIF_PARSED + ML_PARSED + FILE_UPLOAD | 30,047 | 99.997% |
| **PA_EXTRACTED** | **1** | **0.003%** |

30,047건의 ICAO PKD 인증서 중 PA 검증으로 중복 저장된 것은 **0건**. 유일한 PA_EXTRACTED 1건은 ICAO PKD LDIF에 포함되지 않았던 신규 DSC.
