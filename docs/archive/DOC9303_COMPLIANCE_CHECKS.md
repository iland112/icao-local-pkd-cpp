...
## 부록: BSI TR-03110 알고리즘 지원

Doc 9303 Part 12 기본 목록 외에 BSI TR-03110에서 지원하는 알고리즘은 **WARNING** 수준으로 분류한다 (FAIL이 아님).

### WARNING 분류 대상

| 항목 | 분류 | 근거 |
|------|------|------|
| SHA-1 (RSA/ECDSA) | WARNING (deprecated) | ICAO NTWG 단계적 폐지 권고, 기존 인증서 호환 |
| SHA-224 (RSA/ECDSA) | WARNING (BSI TR-03110) | BSI TR-03110 Part 3 지원, Doc 9303 Part 12 외 |
| brainpoolP256r1 | WARNING (BSI TR-03110) | RFC 5639, 독일 등 유럽 국가 CSCA에서 실제 사용 |
| brainpoolP384r1 | WARNING (BSI TR-03110) | RFC 5639, ICAO PKD에 등록된 유효 인증서 존재 |
| brainpoolP512r1 | WARNING (BSI TR-03110) | RFC 5639, Doc 9303 Part 11이 BSI TR-03110 참조 |

상세 내용은 `docs/BSI_TR03110_ALGORITHM_SUPPORT.md` 참조.
