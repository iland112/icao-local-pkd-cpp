...
### 해시 알고리즘 추출 (서명 알고리즘 → 해시)

| 파일 | 방식 | RSA-PSS | SHA-224 | SHA-1 (old OID) |
|------|------|---------|---------|-----------------|
| `services/common-lib/src/x509/metadata_extractor.cpp` | NID switch/case | PSS 파라미터 파싱 ✅ | ✅ | `NID_sha1WithRSA` ✅ |
| `services/pkd-management/src/common/x509_metadata_extractor.cpp` | 문자열 매칭 + PSS 폴백 | PSS 파라미터 파싱 ✅ | ✅ | 문자열 "sha1" ✅ |
