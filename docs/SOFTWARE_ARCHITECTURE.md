...
- **1 Frontend**: React 19 SPA (27 pages)
...
graph TD
    subgraph "React Application Structure"
        ...
        subgraph "Page Components (27 Pages)"
...
ICAO Local PKD v2.35.0은 **마이크로서비스 아키텍처**, **Multi-DBMS**, **ICAO 9303 완전 준수**, **CSR 기반 PKD 연계**를 통해 높은 성능, 확장성, 보안성을 제공합니다.
...
- ✅ JWT 인증 + RBAC + API Key 인증 (X-API-Key) + Dual Audit Logging
...
- ✅ C++20 고성능 백엔드 + React 19 모던 프론트엔드 (27 페이지)
