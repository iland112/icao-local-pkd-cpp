/**
 * @file sod_parser_service.h
 * @brief Service for SOD (Security Object Document) parsing
 *
 * Handles SOD parsing, DSC extraction, and data group hash extraction.
 * Business logic for SOD operations.
 *
...
public:
     ...
     */
    domain::models::SodData parseSod(const std::vector<uint8_t>& sodBytes);
