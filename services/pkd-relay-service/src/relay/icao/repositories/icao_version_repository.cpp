...
bool IcaoVersionRepository::insert(const icao::relay::icao_module::domain::models::IcaoVersion& version) {
...
std::optional<icao::relay::icao_module::domain::models::IcaoVersion> IcaoVersionRepository::getByFileName(
    ...
    std::optional<icao::relay::icao_module::domain::models::IcaoVersion> result = std::nullopt;
...
std::vector<icao::relay::icao_module::domain::models::IcaoVersion> IcaoVersionRepository::getLatest() {
    PGconn* conn = PQconnectdb(connInfo_.c_str());
    if (PQstatus(conn) != CONNECTION_OK) {
        spdlog::error("[IcaoVersionRepository] DB connection failed");
        PQfinish(conn);
    ...
    std::vector<icao::relay::icao_module::domain::models::IcaoVersion> versions;
...
std::vector<icao::relay::icao_module::domain::models::IcaoVersion> IcaoVersionRepository::getHistory(int limit) {
    PGconn* conn = PQconnectdb(connInfo_.c_str());
    if (PQstatus(conn) != CONNECTION_OK) {
        spdlog::error("[IcaoVersionRepository] DB connection failed");
        PQfinish(conn);
...
std::vector<icao::relay::icao_module::domain::models::IcaoVersion> IcaoVersionRepository::getAllVersions() {
    PGconn* conn = PQconnectdb(connInfo_.c_str());
    if (PQstatus(conn) != CONNECTION_OK) {
        spdlog::error("[IcaoVersionRepository] DB connection failed");
        PQfinish(conn);
