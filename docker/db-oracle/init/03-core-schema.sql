...
-- =============================================================================
-- Version: 2.34.0 (Consolidated — absorbs 13, 14, 15 migration files)
-- Updated: 2026-03-15
...
-- Oracle parity indexes (PostgreSQL already has these)
...
CREATE INDEX idx_certificate_type_created ON certificate(certificate_type, created_at);
...
-- fingerprint_sha256 already covered by uq_lc_fingerprint UNIQUE constraint
