...
CREATE TABLE operation_audit_log (
    ...
    CONSTRAINT chk_op_type CHECK (operation_type IN ('FILE_UPLOAD', 'CERT_EXPORT', 'UPLOAD_DELETE', 'CERTIFICATE_SEARCH', 'PA_VERIFY', 'PA_PARSE_SOD', 'PA_PARSE_DG1', 'PA_PARSE_DG2', 'SYNC_TRIGGER', 'SYNC_CHECK', 'RECONCILE', 'REVALIDATE', 'CONFIG_UPDATE', 'SYSTEM_HEALTH', 'RECONCILIATION', 'USER_MANAGEMENT', 'SYSTEM_CONFIG', 'UNKNOWN'))
);
